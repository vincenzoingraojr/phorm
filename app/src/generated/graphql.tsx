 ...
 * });
 */
export function useEditChatInfoMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<EditChatInfoMutation, EditChatInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<EditChatInfoMutation, EditChatInfoMutationVariables>(EditChatInfoDocument, options);
      }
